                        ...
                        DbContextOptions<ApplicationDbContext>>()))
            {
                ...
                if (!context.Books.Any())
                {
                    context.Books.AddRange(
                        new Book { Title = "Book 1", Author = "Author 1", GenreId = 1, DateAdded = DateTime.Now, ReleaseDate = DateTime.Now.AddDays(-100), NumberInStock = 3},
                        new Book { Title = "Book 2", Author = "Author 2", GenreId = 2, DateAdded = DateTime.Now, ReleaseDate = DateTime.Now.AddDays(-555), NumberInStock = 1},
                        new Book { Title = "Book 3", Author = "Author 3", GenreId = 3, DateAdded = DateTime.Now, ReleaseDate = DateTime.Now.AddDays(-2000), NumberInStock = 2}
                    );
                }
